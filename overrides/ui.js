var UI = (function(){
  ...
  function __onPageLoadComplete(e){
    ...
    pageFinal=pageId
    setTimeout(function(){
      __updateTOC(currentChapterModel);$(".toc ol li").eq(pageId).addClass("active");
    },500)
    ...
    if(pageModel.pageStatus!="completed"){
      ...
      if(lockEnabled){
        ...
        function onTimeOut(){
          ...
          clearInterval(lockinTimer);
          EventManger.trigger(UIEvents.LOCK_TIMEDOUT,{
            pageModel:pageModel
          });
  ...
  function __updateTOC(chapterModel){
    ...
    $(".toc ol li a").click(function(){
      ...
      {
        EventManger.trigger(NavigationEvents.PAGE_LOAD_REQUEST, {
  ...
  function __initialiseUIElements(){
    ...
    $('.popup-with-form').click(function(){
      ...
      function f(){
        var evtObj ={
          exit:".mfp-close", elements:".notes-accessible", parent:".white-popup-block"
        };
        $.magnificPopup.open({
          type: 'inline',
          items: {
          ...
          callbacks: {
            ...
            close: function(){
              $("body").css("overflow","")
              $(".ui-container").css("position","absolute"); $("html").css("position","absolute");$("html").css("width","100%"); console.log("css auto absolute555");
              EventManger.trigger(UIEvents.NOTES_CLOSE);
            }
          },
          mainClass:"note-popup"
    ...
    $(".menu .close").click(function(){
      ...
      $("body").css("overflow","")
      $(".ui-container").css("position","absolute"); console.log("css auto absolute555");
      return false;
    });
    ...
    function __onMenuToggle()
    {
      ...
      if($(".menu").hasClass("open")){
        var eventObj ={
          exit:".menu .close", elements:".menu ul li a"
        };
    ...
    function __onTOCOpen()
    {
      ...
      var evtObj ={
        exit:".close-toc", elements:".accessible-menu li"
      }; setTimeout(function(){
        EventManger.trigger(ComplianceEvents.INIT_FOCUS_LIST,evtObj);
      },500);
    }
    ...
    $(".menu-link#menu-glossary-link").magnificPopup({
      ...
      callbacks:{
        ajaxContentAdded:function(){
          ...
          var evtObj ={
            exit:".mfp-close", elements:".glossary-heading .menu-item[tabindex=\"0\"]", parent:".glossary"
          };
        ...
        close:function(){
          ...
          $("body").css("overflow",""); console.log("css auto absolute555");;
    ...
    $(".menu-link#menu-help-link").magnificPopup({
      ...
      callbacks:{
        ajaxContentAdded:function(){
          ...
          $(".ui-container").css("position","fixed"); $("html").css("position","fixed");$("html").css("width","100%");;
          var eventObj ={
            exit:".mfp-close", elements:".helpContainer .help-item-description", parent:".mfp-content.help-popup"
          };
          EventManger.trigger(ComplianceEvents.INIT_FOCUS_LIST, eventObj);
        },
        close:function(){
